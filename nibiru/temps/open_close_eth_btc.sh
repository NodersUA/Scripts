...
nibid tx perp open-position buy ubtc:unusd $(echo "scale=1; $(shuf -i 10-100 -n 1) / 10" | bc) $(shuf -i 10000000-30000000 -n 1) 0 --from wallet --gas-adjustment 1.4 --gas auto --gas-prices 0.025unibi -y
