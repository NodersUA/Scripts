...
command=$"nibid tx perp open-position buy ueth:unusd $(echo "scale=1; $(shuf -i 10-100 -n 1) / 10" | bc) $(shuf -i $percentage_min-$percentage_max -n 1)000 0 --from wallet --gas-adjustment 1.4 --gas auto --gas-prices 0.025unibi -y"
echo $command && eval $command
