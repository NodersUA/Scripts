...
echo -e "${BLUE}  NNNNN NNN OO       OO DD     DD EEEEEE   RRRRRR   SSSSS    UU      UU    AAAAAAAA     ${ENDCOLOR}" 
echo -e "${YELLOW}  NNNNN NNN OO       OO DD     DD EEEEEE   RRRRRR   SSSSS    UU      UU    AAAAAAAA     ${ENDCOLOR}" 
