...
echo -e "\033[0;34m"      " NN    NNN    OOOOO    DDDDDD    EEEEEEEE RRRRRR   SSSSS    UU      UU      AAA "   
                     echo " NNN   NNN  OO     OO  DD    DD  EE       RR   RR SS        UU      UU     AA AA "   
                     echo " NNNN  NNN OO       OO DD     DD EE       RR   RR SS        UU      UU     AA  AA "   
                     echo " NNNNN NNN OO       OO DD     DD EEEEEE   RRRRRR   SSSSS    UU      UU    AAAAAAAA "   echo -e "\e[0m"
echo -e "\033[0;33m"      " NNNNN NNN OO       OO DD     DD EEEEEE   RRRRRR   SSSSS    UU      UU    AAAAAAAA "   
